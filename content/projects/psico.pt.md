...
features:
  ...
  - "Sistema de notificações por polling para solicitações de reagendamento"
...
highlights:
  ...
  - "Autenticação JWT com cookie HttpOnly e guards por role (ADMIN/PATIENT)"
  - "Enums com mapeamento de UI (label, cor, ícone) — zero lógica de apresentação nos componentes"
  - "Repository Pattern com interfaces no backend Laravel"
  - "Docker Compose orquestrando Laravel + MySQL + phpMyAdmin em rede isolada"
